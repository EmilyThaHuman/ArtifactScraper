...
LABEL org.opencontainers.image.source=https://github.com/EmilyThaHuman/ArtifactScraper
LABEL org.opencontainers.image.description="ArtifactScraper All-in-One Server"
...
ENV ANYCRAWL_API_DB_CONNECTION=/usr/src/app/storage/artifactscraper.db
